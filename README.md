...
3. enter `/local/HA-Alarm-Clock-Cards/alarms-card.js` or `/local/hHA-Alarm-Clock-Cards/reminders-card.js` and choose **JavaScript Module** as the resource type for the alarm card
